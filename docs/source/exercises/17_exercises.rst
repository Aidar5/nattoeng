...
Interfaces should be written with space. Like Fa 0/0, not Fa0/0.
...
Function write_last_log_to_csv() handles mail_log.csv file. File mail_log.csv contains logs of user name user name. At the same time, user cannot change email, only name.
